...
export default function WebsiteSwitcher() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="flex items-center gap-2 max-w-[250px] px-3 py-2 border border-gray-300 rounded-md bg-white hover:bg-gray-50 transition-colors">
        <svg
